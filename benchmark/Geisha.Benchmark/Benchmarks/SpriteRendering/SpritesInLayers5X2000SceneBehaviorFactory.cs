...
namespace Geisha.Benchmark.Benchmarks.SpriteRendering
{
    internal sealed class SpritesInLayers5X2000SceneBehaviorFactory : ISceneBehaviorFactory
    {
        ...
        public SceneBehavior Create(Scene scene) => new SpritesInLayers5X2000SceneBehavior(scene, _entityFactory);
        ...
        private sealed class SpritesInLayers5X2000SceneBehavior : SceneBehavior
        {
            ...
            protected override void OnLoaded()
            {
                ...
                for (var i = 0; i < 10000; i++)
                {
                    ...
                    entity.GetComponent<SpriteRendererComponent>().SortingLayerName = $"Layer{i % 5}";
                }
            }
        }
    }
