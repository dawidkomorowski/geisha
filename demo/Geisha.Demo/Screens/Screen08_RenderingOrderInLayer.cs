...
{
    internal sealed class RenderingOrderInLayerSceneBehaviorFactory : ISceneBehaviorFactory
    {
        private const string SceneBehaviorName = "Screen08_RenderingOrderInLayer";
        private readonly CommonScreenFactory _commonScreenFactory;

        public RenderingOrderInLayerSceneBehaviorFactory(CommonScreenFactory commonScreenFactory)
        {
            _commonScreenFactory = commonScreenFactory;
        }

        public string BehaviorName => SceneBehaviorName;
        public SceneBehavior Create(Scene scene) => new RenderingOrderInLayerSceneBehavior(scene, _commonScreenFactory);

        private sealed class RenderingOrderInLayerSceneBehavior : SceneBehavior
        {
            private readonly CommonScreenFactory _commonScreenFactory;

            public RenderingOrderInLayerSceneBehavior(Scene scene, CommonScreenFactory commonScreenFactory) : base(scene)
            {
                _commonScreenFactory = commonScreenFactory;
            }
            ...
            protected override void OnLoaded()
            {
                ...
                textRenderer1.Text = @"You can control order of rendering within a layer.
