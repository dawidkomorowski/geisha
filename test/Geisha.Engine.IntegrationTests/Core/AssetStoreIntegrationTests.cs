...
public class AssetStoreIntegrationTests : IntegrationTests<AssetStoreIntegrationTestsSut>
{
    ...
    public void GetAsset_ShouldLoadAndReturn_InputMapping()
    {
        ...
        Assert.That(inputMapping.ActionMappings[0].HardwareActions[0].InputSource,
        ...
        Assert.That(inputMapping.ActionMappings[1].HardwareActions[0].InputSource,
        ...
        Assert.That(inputMapping.AxisMappings[0].HardwareAxes[0].InputSource, Is.EqualTo(InputSource.Create(Key.W)));
        Assert.That(inputMapping.AxisMappings[0].HardwareAxes[0].Scale, Is.EqualTo(1));
        Assert.That(inputMapping.AxisMappings[0].HardwareAxes[1].InputSource, Is.EqualTo(InputSource.Create(Key.S)));
        ...
        Assert.That(inputMapping.AxisMappings[1].HardwareAxes[0].InputSource, Is.EqualTo(InputSource.Create(Key.D)));
        Assert.That(inputMapping.AxisMappings[1].HardwareAxes[0].Scale, Is.EqualTo(1));
        Assert.That(inputMapping.AxisMappings[1].HardwareAxes[1].InputSource, Is.EqualTo(InputSource.Create(Key.A)));
