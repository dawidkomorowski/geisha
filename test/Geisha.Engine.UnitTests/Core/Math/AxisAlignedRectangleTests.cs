...
public class AxisAlignedRectangleTests
{
    ...
    public void Constructor_FromDimensions_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(new Vector2(12.3, 45.6));

        // Assert
        Assert.That(rectangle.Center, Is.EqualTo(Vector2.Zero));
        Assert.That(rectangle.Dimensions, Is.EqualTo(new Vector2(12.3, 45.6)));
    }
    ...
    public void Constructor_FromSizeD_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(new SizeD(12.3, 45.6));
    ...
    [Test]
    public void Constructor_FromSize_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(new Size(123, 456));
    ...
    public void Constructor_FromWidthAndHeight_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(12.3, 45.6);
    ...
    public void Constructor_FromCenterAndDimensions_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(new Vector2(12, 34), new Vector2(5.6, 7.8));

        // Assert
        Assert.That(rectangle.Center, Is.EqualTo(new Vector2(12, 34)));
        Assert.That(rectangle.Dimensions, Is.EqualTo(new Vector2(5.6, 7.8)));
    }

    [Test]
    public void Constructor_FromCenterAndSizeD_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(new Vector2(12, 34), new SizeD(5.6, 7.8));
    ...
    [Test]
    public void Constructor_FromCenterAndSize_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(new Vector2(12, 34), new Size(56, 78));
    ...
    public void Constructor_FromCenterXAndCenterYAndWidthAndHeight_ShouldSetCenterAndDimensions()
    {
        // Arrange
        // Act
        var rectangle = new AxisAlignedRectangle(12, 34, 5.6, 7.8);
