...
public class ComponentDataSerializationTests : ComponentSerializationTestsBase
{
    ...
    public void SerializeAndDeserialize_Defined()
    {
        ...
        TestComponent.SerializeAction = (_, writer) => writer.WriteString("DefinedProperty", "defined");
        TestComponent.DeserializeAction = (_, reader) => actual = reader.IsDefined("DefinedProperty");

        // Act
        SerializeAndDeserialize<TestComponent>(_ => { });
    ...
    public void SerializeAndDeserialize_Undefined()
    {
        ...
        TestComponent.SerializeAction = (_, _) => { };
        TestComponent.DeserializeAction = (_, reader) => actual = reader.IsDefined("UndefinedProperty");
    ...
    public void SerializeAndDeserialize_Null()
    {
        ...
        TestComponent.SerializeAction = (_, writer) => writer.WriteNull("NullProperty");
        TestComponent.DeserializeAction = (_, reader) => actual = reader.IsNull("NullProperty");
    ...
    public void SerializeAndDeserialize_NotNull()
    {
        ...
        TestComponent.SerializeAction = (_, writer) => writer.WriteString("NotNullProperty", "not null");
        TestComponent.DeserializeAction = (_, reader) => actual = reader.IsNull("NotNullProperty");
    ...
    [Test]
    public void SerializeAndDeserialize_UInt()
    {
        // Arrange
        const uint value = 123;

        TestComponent.SerializeAction = (component, writer) => writer.WriteUInt("UIntProperty", component.UIntProperty);
        TestComponent.DeserializeAction = (component, reader) => component.UIntProperty = reader.ReadUInt("UIntProperty");

        // Act
        var actual = SerializeAndDeserialize<TestComponent>(component => { component.UIntProperty = value; });

        // Assert
        Assert.That(actual.UIntProperty, Is.EqualTo(value));
    }
    ...
    public void SerializeAndDeserialize_Object()
    {
        ...
        TestComponent.SerializeAction = (component, writer) => writer.WriteObject("ObjectProperty", component.ObjectProperty, (customData, objectWriter) =>
        {
            ...
            objectWriter.WriteUInt("UIntProperty", customData.UIntProperty);
        ...
        TestComponent.DeserializeAction = (component, reader) =>
        {
            ...
            component.ObjectProperty = reader.ReadObject("ObjectProperty", objectReader =>
            {
                ...
                return new TestComponent.CustomData
                {
                    ...
                    UIntProperty = objectReader.ReadUInt("UIntProperty"),
        ...
        Assert.That(actual.ObjectProperty.UIntProperty, Is.EqualTo(value.UIntProperty));
        ...
        Assert.That(objectProperties, Has.Length.EqualTo(12));
        Assert.That(objectProperties,
            Is.EqualTo(new[]
            {
                "NullProperty", "BoolProperty", "IntProperty", "UIntProperty", "DoubleProperty", "StringProperty", "EnumProperty", "Vector2Property",
                "Vector3Property", "AssetIdProperty", "ColorProperty", "ObjectProperty"
            }));
    ...
    private sealed class TestComponent : Component
    {
        ...
        public CustomData ObjectProperty { get; set; } = new();
        ...
        public sealed class CustomData
        {
            ...
            public AssetId AssetIdProperty { get; set; }
            public Color ColorProperty { get; set; }
            public CustomNestedData ObjectProperty { get; set; } = new();
        }
        ...
        public static Action<TestComponent, IComponentDataWriter> SerializeAction { get; set; } = (_, _) =>
            throw new InvalidOperationException($"{nameof(SerializeAction)} was not set.");

        public static Action<TestComponent, IComponentDataReader> DeserializeAction { get; set; } = (_, _) =>
