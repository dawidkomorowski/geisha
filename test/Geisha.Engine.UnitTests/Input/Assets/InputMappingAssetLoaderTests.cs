        ...
        private static IEnumerable<LoadTestCase> LoadTestCases => new[]
        {
            ...
            new LoadTestCase("Multiple keyboard keys mapped as single action",
                ...
                mapping =>
                {
                    ...
                    Assert.That(mapping.ActionMappings.Single().HardwareActions.ElementAt(0).InputElement,
                        Is.EqualTo(InputElement.Create(Key.C)));
                    Assert.That(mapping.ActionMappings.Single().HardwareActions.ElementAt(1).InputElement,
                        Is.EqualTo(InputElement.Create(Key.LeftCtrl)));
                }),
            ...
            new LoadTestCase("Multiple keyboard keys mapped as single axis",
                ...
                mapping =>
                {
                    ...
                    Assert.That(mapping.AxisMappings.Single().HardwareAxes.ElementAt(0).InputElement,
                        Is.EqualTo(InputElement.Create(Key.Up)));
                    Assert.That(mapping.AxisMappings.Single().HardwareAxes.ElementAt(0).Scale, Is.EqualTo(1.02));
                    Assert.That(mapping.AxisMappings.Single().HardwareAxes.ElementAt(1).InputElement,
                        Is.EqualTo(InputElement.Create(Key.Down)));
