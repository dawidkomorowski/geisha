...
namespace Geisha.Cli.IntegrationTests
{
    ...
    public class GeishaCliIntegrationTests
    {
        ...
        public void Asset_Create_Sound_ShouldCreateSoundAssetFileInTheSameDirectoryAsSoundFile_GivenSoundFilePath()
        {
            ...
            Assert.That(assetData.AssetId, Is.Not.EqualTo(AssetId.Empty));
        ...
        public void Asset_Create_Sprite_ShouldCreateTextureAssetFileAndSpriteAssetFileInTheSameFolderAsTextureFile_GivenTextureFilePath()
        {
            ...
            Assert.That(textureAssetData.AssetId, Is.Not.EqualTo(AssetId.Empty));
            ...
            Assert.That(spriteAssetData.AssetId, Is.Not.EqualTo(AssetId.Empty));
        ...
        public void Asset_Create_Sprite_ShouldCreateSpriteAssetFiles_GivenSpriteParameters(string parameters)
        {
            ...
            Assert.That(assetData1.AssetId, Is.Not.EqualTo(AssetId.Empty));
            ...
            Assert.That(assetData2.AssetId, Is.Not.EqualTo(AssetId.Empty));
            ...
            Assert.That(assetData3.AssetId, Is.Not.EqualTo(AssetId.Empty));
            ...
            Assert.That(assetData4.AssetId, Is.Not.EqualTo(AssetId.Empty));
        ...
        public void Asset_Create_InputMapping_ShouldCreateDefaultInputMappingAssetFileInCurrentDirectory()
        {
            ...
            Assert.That(inputMappingAssetData.AssetId, Is.Not.EqualTo(AssetId.Empty));
