namespace Geisha.Engine.Core.Math
{
    ...
    public interface IShape
    {
        ...
        ///     <br />
        ///     You can return empty array as simple implementation of this method.
        ///     <br />
        ///     If this method returns empty array then SAT provides automatic axis discovery. For each polygon edge there is
        ///     computed single axis. Therefore for certain shapes it is highly recommended to provide custom axes to reduce
        ///     complexity and improve performance. In example rectangle requires only two unique axes (as it consists of two pairs
        ///     of parallel edges) while default SAT discovery will produce four axes for rectangle (one for each edge).
        /// </remarks>
        Axis[] GetAxes();
