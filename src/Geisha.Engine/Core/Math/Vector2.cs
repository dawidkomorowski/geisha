...
public readonly struct Vector2 : IEquatable<Vector2>
{
    ...
    /// <summary>
    ///     Length of <see cref="Vector2" /> squared. <see cref="LengthSquared" /> is cheaper to calculate than
    ///     <see cref="Length" />.
    /// </summary>
    ...
    /// <summary>
    ///     Computes angle in radians between this <see cref="Vector2" /> and other <see cref="Vector2" />.
    /// </summary>
    /// <param name="other">Other <see cref="Vector2" />.</param>
