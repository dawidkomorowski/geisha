...
internal sealed class RenderingModule : Module
{
    ...
    {
        builder.RegisterType<DebugRenderer>()
            .As<IDebugRenderer>()
            .As<IDebugRendererForRenderingSystem>()
            .SingleInstance();
        ...
        // Diagnostics
        builder.RegisterType<RenderingDiagnosticInfoProvider>()
            .As<IRenderingDiagnosticInfoProvider>()
            .As<IDiagnosticInfoProvider>()
            .SingleInstance();

        // Systems
        builder.RegisterType<RenderingSystem>()
            .As<IRenderingSystem>()
            .As<IRenderingGameLoopStep>()
            .As<ISceneObserver>()
            .SingleInstance();
    }
}